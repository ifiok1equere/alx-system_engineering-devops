0-iam_betty: contains code that when executed switches from the current user to betty
...
12-directory_permissions: contain command that when executed will Create a script that creates a directory called my_dir with permissions 751 in the working directory
13-change_group: contains command that when executed Write a script that changes the group owner to school for the file hello
100-change_owner_and_group: contain command that when executed Write a script that changes the owner to vincent and the group owner to staff for all the files and directories in the working directory.
101-symbolic_link_permissions: contain command that when executed Write a script that changes the owner and the group owner of _hello to vincent and staff respectively
102-if_only: contain command that when executed Write a script that changes the owner of the file hello to betty only if it is owned by the user guillaume
103-Star_Wars: script to play starwars episode iv
